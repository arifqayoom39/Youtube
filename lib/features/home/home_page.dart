      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(
            ...
            onPressed: () async {
              await ref.read(authProvider).deleteSession(sessionId: 'current');
            },
          ),
        ],
      ),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.all(8.0),  // Added padding around CircleAvatar
                                    child: CircleAvatar(
          ...
          child: Shimmer.fromColors(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                // Shimmer for profile picture and video details
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Padding(
